  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#dccfc1] bg-[rgba(252,248,243,0.94)] backdrop-blur">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-6 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <button
          type="button"
          className="inline-flex items-center justify-center rounded-full border border-[#cdb8a5] px-4 py-2 text-sm font-medium text-[#5d3e27] transition hover:bg-[#f2e6da] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#7d5c3c] md:hidden"
        ...
        <nav
          id="site-navigation"
          className={`${isMenuOpen ? "flex" : "hidden"} absolute inset-x-4 top-full mt-2 flex-col rounded-3xl border border-[#dccfc1] bg-[#fffaf5] p-3 shadow-lg md:static md:mt-0 md:flex md:flex-row md:items-center md:gap-2 md:border-0 md:bg-transparent md:p-0 md:shadow-none`}
